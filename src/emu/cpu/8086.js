...
export default class CPU8086 extends CPU {
  constructor(config) {
    ...
    this.inst[0xAA]    = new inst(oper.stosb,  1, u                  );
    this.inst[0xAB]    = new inst(oper.stosw,  1, u                  );
    this.inst[0xAC]    = new inst(oper.lodsb,  1, u                  );
    this.inst[0xAD]    = new inst(oper.lodsw,  1, u                  );
    this.inst[0xAE]    = new inst(oper.scasb,  1, u                  );
    this.inst[0xAF]    = new inst(oper.scasw,  1, u                  );
