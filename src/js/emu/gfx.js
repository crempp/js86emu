...
// To avoid a circular dependency we inject the required Cpu module in
// setupGraphics() rather than require it.
define([],
function()
{
    var _Cpu = null;
    ...
    var Gfx = {
        ...
        // TODO : Investigate animation stuff
        //window.onload = main;
        ...
        setupGraphics : function (canvas, cpu, cb)
        {
            _Cpu = cpu;
        ...
        drawGraphics : function()
        {
            ...
            var gfxMem = _Cpu.getMemoryBlock(this._gfxMemStart, this._gfxMemSize);
